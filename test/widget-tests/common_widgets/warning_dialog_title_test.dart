...
void main() {
  group('Common Widget - WarningDialogTitle', () {
    testWidgets('WarningDialogTitle renders as expected',
        (WidgetTester tester) async {
      // find
      final widget = WarningDialogTitle(
        title: "Lorem Ipsum",
      );
      final widgetFinder = find.byType(WarningDialogTitle);
